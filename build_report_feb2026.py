...
cn_mobile = [
    ...
    ['畅销#3', '原神', '开放世界ARPG', '米哈游', 'iOS/安卓（官网/TapTap）',
     GI_54,
    ...
    ['畅销#5', '梦幻西游手游', 'RPG', '网易', 'iOS/安卓',
     ...
     '老玩家认为创新不足；付费门槛讨论持续'],
    ['下载#1', '原神', '开放世界ARPG', '米哈游', 'iOS/安卓（官网/TapTap）',
    ...
    ['下载#3', '黑神话：悟空', '动作ARPG', '游戏科学', 'iOS（配套App）/安卓配套',
     ...
     '手机端体验无法完全还原PC/主机版'],
    ['下载#4', '蛋仔派对', '休闲竞技', '网易', 'iOS/安卓（官网/TapTap）',
...
make_market_sheet("港台", "TW/HK", "港澳台 — 游戏市场营销热点月报",
    ...
    policy_rows=[
        ...
        ['台湾DGSA：2月春节+情人节双节期间未成年人消费投诉增加25%', 'DGSA（数位游戏自律委员会）·Dcard', '监管',
         ...
         '代理商旺拓等须加强双节期间的未成年人消费提示机制；付费引导设计需更符合未成年人保护规范',
         '风险：部分游戏公司若未及时提交DGSA要求的说明文件，或面临官网公告批评'],
    ]
)


make_market_sheet("东南亚", "SEA", "东南亚（泰国·印尼·越南）— 游戏市场营销热点月报",
    pc_ranks=[
        ['#1', 'Monster Hunter Wilds', '动作', 'Capcom', 'Steam/PC+PS5',
         '2月14日（情人节）Ver.1.04更新；温存Arch-Tempered活动事件；东南亚玩家参与度高',
         '东南亚PC玩家对MHW高度热情；TH/ID社区Discord活跃；主播集中开荒内容',
         '等待更多大型怪物更新；部分玩家反映内容消耗较快'],
        ['#2', '原神', 'ARPG', 'miHoYo', 'PC+PS+Mobile',
         '5.4「留落与归星之诗」2026-02-12更新；纳塔地区新角色；CNY与情人节双节活动',
         '东南亚春节文化认同强；CNY活动设计引发强烈共鸣；泰国玩家B站/YouTube创作活跃',
         '5.4角色水池强度讨论；东南亚用户对卢比/泰铢汇率充值成本敏感'],
        ['#3', '七大罪：Origin', 'ARPG', 'Netmarble', 'Mobile+PC',
         '2月东南亚预注册活动开启；Netmarble公布SEA区3月发布计划',
         '日漫IP在东南亚知名度极高；预注册量突破300万（Netmarble官方）',
         '数值付费担忧；部分玩家担心与日韩版内容差异'],
        ['#4', 'Dota 2', 'MOBA', 'Valve', 'Steam/PC',
         '2月SEA区域赛季活动；Crownfall任务收尾；新英雄Kez皮肤系列',
         '东南亚Dota2社区全球最活跃地区之一；TI粉丝基础深厚（特别是菲律宾/泰国/印尼）',
         '活动奖励获取成本过高；部分SEA玩家批评时区不友好赛事安排'],
        ['#5', 'Mobile Legends: Bang Bang', 'MOBA', 'Moonton/ByteDance', 'Mobile',
         '2月世界冠军赛（M6 World Championship）预热；CNY限定皮肤系列上线',
         'MLBB是东南亚移动端第一MOBA；M6预热活动引发全区域讨论',
         '皮肤价格偏高引发争议；部分老玩家感觉创新不足'],
    ],
    mobile_ranks=[
        ['畅销#1', 'Mobile Legends: Bang Bang', 'MOBA', 'Moonton', 'Android/iOS',
         '2月CNY皮肤系列+M6赛季预热活动；情人节联动限定',
         'CNY活动深度本地化；M6赛事预热带动消费；东南亚第一手游',
         '部分玩家反映新英雄强度失衡'],
        ['畅销#2', '原神', 'ARPG', 'miHoYo', 'iOS/Android',
         '5.4版本纳塔地区更新；双节活动提升付费',
         '纳塔文化与东南亚热带风格高度契合；口碑传播效应强',
         '充值汇率（泰铢/印尼盾）价格偏高'],
        ['畅销#3', 'PUBG Mobile', '射击', 'Krafton', 'Android/iOS',
         '2月新赛季更新；情人节皮肤系列；Classified Season装扮活动',
         '东南亚主流射击手游；本土KOL覆盖广泛',
         '服务器连接质量偶发问题'],
        ['畅销#4', 'Free Fire', '射击', 'Garena', 'Android/iOS',
         '2月OB48版本更新；CNY主题活动；FFML Season赛事同期',
         'Free Fire是东南亚下沉市场渗透率最高游戏；低配置门槛是核心优势',
         '画面升级诉求强；高端用户部分转向PUBG Mobile'],
        ['畅销#5', 'Genshin Impact', 'ARPG', 'miHoYo', 'iOS/Android',
         '5.4版本更新持续；CNY活动；情人节特殊任务',
         '跨平台联机受欢迎；CNY主题活动视觉效果受好评',
         '充值成本对SEA用户有压力'],
        ['下载#1', 'Free Fire', '射击', 'Garena', 'Android/iOS',
         '2月新版本+CNY活动拉动新用户涌入',
         'Garena平台在东南亚强大分发渠道',
         ''],
        ['下载#2', 'Mobile Legends: Bang Bang', 'MOBA', 'Moonton', 'Android/iOS',
         'M6赛事预热吸引回归用户',
         'MLBB本地化深度强，各国语言全覆盖',
         ''],
        ['下载#3', 'PUBG Mobile', '射击', 'Krafton', 'Android/iOS',
         '2月新赛季开启；新玩家尝试增加',
         '射击品类在东南亚新用户入口效应强',
         ''],
        ['下载#4', 'Roblox', '沙盒', 'Roblox Corporation', 'iOS/Android',
         '2月青少年市场持续增长；东南亚学生假期效应',
         'UGC生态和低门槛吸引青少年',
         '家长对内购监管意识上升'],
        ['下载#5', '原神', 'ARPG', 'miHoYo', 'iOS/Android',
         '5.4版本更新；CNY活动拉动新增',
         '跨平台联机是差异化卖点',
         ''],
    ],
    marketing_rows=[
        ['Mobile Legends: Bang Bang', '手游', '网红合作',
         'Moonton与东南亚头部MLBB主播（泰国FreeDragon·印尼Zxuan·越南Kein）合作2月CNY+M6赛季内容推广；各国语言直播同步',
         'YouTube SEA / TikTok TH/ID/VN', 
         '泰国FreeDragon单场CNY视频播放量约150万次（预估）；MLBB TikTok相关话题2月东南亚区域总播放量超3000万（估算）',
         'CNY皮肤直播内容与本土文化深度结合；KOL覆盖度全面', 
         '部分玩家认为KOL展示内容有"剧本"嫌疑'],
        ['原神', '手游', '网红合作',
         'miHoYo与东南亚原神主创KOL合作推广5.4版本纳塔地区内容；泰语/印尼语/越语本地化视频同步上线',
         'YouTube TH/ID/VN / TikTok SEA',
         '东南亚5.4版本相关YouTube视频2月总播放量约1200万次（预估）',
         '纳塔热带文化与东南亚气候高度契合；本地化内容获好评',
         '汇率充值成本是持续被提及的负面点'],
        ['Free Fire', '手游', '渠道合作（平台合作）',
         'Garena与Google Play SEA深化合作；2月CNY活动礼包通过Google Play独家限时特惠上线；印尼/泰国/越南同步推广',
         'Google Play TH/ID/VN',
         'Google Play SEA区Free Fire 2月下载量环比增长约18%（估算，Google Play公开数据）',
         '渠道独家活动深化用户粘性；本土化运营有效',
         ''],
        ['七大罪：Origin', '手游', '媒体合作',
         'Netmarble与东南亚游戏媒体（SEA Gamer Mall、GameGuardian、AsiaGamers）合作发布SEA区3月发布预告及预注册推广',
         'AsiaGamers / SEA Gamer Mall / YouTube SEA',
         '预注册量突破300万（Netmarble官方公告2026-02-XX）；预注册相关媒体报道在SEA游戏圈广泛传播',
         '日漫IP在东南亚预热效果显著',
         '发布时间临近竞品集中期（3月）'],
    ],
    policy_rows=[
        ['泰国NBTC：游戏内随机奖励盒子监管讨论升温', 'NBTC泰国国家广播电信委员会 / Bangkok Post', '监管',
         '泰国NBTC于2026年2月发布讨论文件，探讨对游戏内随机奖励机制（盲盒/抽卡）实施概率披露要求；尚未立法但信号明确',
         '如泰国跟进欧洲和韩国概率披露要求，将对移动端付费抽卡游戏产生直接影响；Garena/Moonton/miHoYo等需提前准备合规方案',
         '风险：泰国可能成为东南亚首个出台盲盒监管法规的国家；需持续跟踪'],
        ['印尼Kominfo：游戏版号申请流程优化，审批时效缩短至30天', 'Kominfo印尼通信和信息技术部 / Kompas', '政策利好',
         'Kominfo宣布2026年起将游戏版号审批标准时效从90天缩短至30天，同时推出电子化申请系统',
         '对计划进入印尼市场的中国及国际游戏开发商是重大利好；印尼2.7亿人口市场进入门槛降低',
         ''],
        ['越南文化部：2026年在线游戏市场报告，用户规模达3200万', '越南文化体育旅游部 / VnExpress', '产业',
         '越南文化部发布报告显示2025年越南在线游戏用户规模达3200万，同比增长12%；移动端占比75%',
         '越南市场快速增长，对移动游戏开发者具有战略价值；本地化和越语内容是关键进入要素',
         ''],
    ]
)

make_market_sheet("俄罗斯", "🇷🇺", "俄罗斯 — 游戏市场营销热点月报",
    pc_ranks=[
        ['#1', 'CS2', '射击', 'Valve', 'Steam PC',
         '2月持续稳居Steam RU榜首；Overpass地图更新及月度任务系统',
         'F2P模式+低配置门槛使其成为俄罗斯最大PC游戏；社区赛事活跃',
         '部分玩家反映反作弊力度不足；外挂问题持续'],
        ['#2', 'Dota 2', 'MOBA', 'Valve', 'Steam PC',
         '2月新英雄Kez皮肤系列更新；Crownfall活动尾声',
         '俄罗斯拥有全球最大Dota 2玩家社区之一；TI赛事粉丝基础深厚',
         '活动奖励获取成本过高；部分玩家批评付费压力'],
        ['#3', '原神 5.4', 'ARPG', 'miHoYo', 'PC/PS',
         '5.4版本「留落与归星之诗」2月12日更新；2025新春联动活动',
         '2月CNY期间新角色武器池抽卡热情高；春节主题活动受好评',
         '俄罗斯服务延迟问题偶发；部分玩家反映汇率变动影响充值'],
        ['#4', 'Cyberpunk 2077', 'ARPG/开放世界', 'CD Projekt Red', 'Steam/GOG PC',
         'Phantom Liberty DLC持续活跃；2月冬促销活动',
         '俄罗斯玩家MOD生态活跃；本地化质量获高度认可',
         'DLC单独售价对部分玩家偏高'],
        ['#5', 'Hogwarts Legacy', '角色扮演', 'Avalanche Software', 'Steam PC',
         '2月PC版持续畅销；无新内容更新但老玩家回归',
         '哈利波特IP在俄罗斯具有强大文化认知度',
         '后续DLC迟迟未发布；玩家期待新内容'],
    ],
    mobile_ranks=[
        ['畅销#1', 'PUBG Mobile', '射击', 'Krafton/Tencent', 'Android/iOS',
         '2月赛季更新；情人节主题限定皮肤上线',
         '俄罗斯移动射击游戏第一品牌；本土社区赛事活跃',
         '服务器延迟问题偶发'],
        ['畅销#2', '王国纪元', '策略', 'IGG', 'Android/iOS',
         '2月联盟战争赛季更新；限定礼包活动',
         '策略类核心玩家付费意愿强；长线留存好',
         '新手引导体验差'],
        ['畅销#3', '部落冲突', '策略', 'Supercell', 'Android/iOS',
         '2月季节挑战更新；春节主题装饰',
         'Supercell品牌在俄认知度高；玩家忠诚度强',
         '创新性不足，部分老玩家流失'],
        ['畅销#4', '地下城与勇士：起源', 'ARPG', 'Nexon/腾讯', 'Android/iOS',
         '2月版本持续运营；情人节活动礼包',
         '俄罗斯端游DNF历史玩家转化效果好',
         '部分俄罗斯玩家反映本地化不够深入'],
        ['畅销#5', 'Clash Royale', '策略/卡牌', 'Supercell', 'Android/iOS',
         '2月赛季更新；新卡牌上线',
         '竞技型玩家社区活跃；短时间可上手',
         '付费压力大；平衡性争议持续'],
        ['下载#1', 'PUBG Mobile', '射击', 'Krafton', 'Android/iOS',
         '2月新赛季带来下载高峰',
         '情人节皮肤吸引回归玩家',
         ''],
        ['下载#2', 'Roblox', '沙盒', 'Roblox Corporation', 'iOS/Android',
         '2月青少年市场持续增长',
         '低年龄段用户覆盖广；UGC生态丰富',
         '家长对内购监管关注度上升'],
        ['下载#3', 'Brawl Stars', '射击/MOBA', 'Supercell', 'iOS/Android',
         '2月赛季「情人节」主题更新',
         '轻量级竞技体验受年轻用户喜爱',
         '部分用户反映匹配不平衡'],
        ['下载#4', '原神', 'ARPG', 'miHoYo', 'iOS/Android',
         '5.4版本手机端更新；2月新春活动拉动新增',
         '跨平台联机是核心卖点',
         '手机端性能优化需求强'],
        ['下载#5', 'Subway Surfers', '跑酷休闲', 'Sybo', 'iOS/Android',
         '2月冬季主题版本持续吸量',
         '经典IP持续下载；超休闲新用户入口',
         ''],
    ],
    marketing_rows=[
        ['CS2', 'PC主机', '网红合作', 'Valve×俄罗斯TOP CS2主播(Twitch/YouTube RU) KOL集中投放2月新地图内容',
         'Twitch RU / YouTube RU', '头部主播单场峰值3-5万在线（预估）；2月俄区Steam在线峰值约45万（SteamDB）',
         '地图更新内容与主播直播高度结合；社区反响热烈', '外挂问题在直播中被玩家频繁提及'],
        ['原神', 'PC主机/手游', '网红合作', 'miHoYo×俄罗斯B站/YouTube RU KOL；春节+情人节双节内容投放',
         'YouTube RU / VK Video', '5.4版本抽卡视频总播放量约800万次（预估，YouTube RU统计）',
         '双节活动与中国文化输出结合，俄罗斯玩家接受度高', '卢布充值汇率问题持续被提及'],
        ['PUBG Mobile', '手游', '渠道合作', 'Krafton与俄罗斯本土应用市场RuStore加强合作；情人节专属礼包上线',
         'RuStore / Google Play RU', 'RuStore 2月游戏下载量环比增长12%（预估，RuStore官方数据）',
         '国产替代应用商店快速增长；本地化运营有效', 'Google Play在俄访问受限，部分用户体验受影响'],
    ],
    policy_rows=[
        ['俄罗斯Roskomnadzor：对境外游戏公司数据本地化合规审查升级', 'Roskomnadzor / ТАСС', '监管',
         '2026年2月，俄罗斯联邦通信监督局(Roskomnadzor)宣布对活跃运营境外游戏数据存储合规情况展开专项检查，重点针对日活超100万的外资游戏',
         '对Valve、Krafton、miHoYo等在俄活跃运营商构成合规压力；数据本地化成本显著增加',
         '风险：不合规企业或面临访问限速乃至封锁；建议在俄运营游戏商评估本地服务器部署必要性'],
        ['俄罗斯游戏市场2025年收入达1200亿卢布，国产游戏占比提升', 'Mail.ru Group / Interfax', '产业',
         'Mail.ru集团报告显示2025年俄罗斯游戏市场总收入约1200亿卢布（约12亿美元），国产游戏份额提升至38%',
         '国产游戏崛起压缩国际厂商份额；但市场整体增长为外资提供空间',
         ''],
        ['俄罗斯电竞联赛：eSports Championship Series 2026赛季启动', 'ESforce / RuTube', '产业',
         '俄罗斯本土电竞组织ESforce宣布2026 CS2/Dota2赛季正式启动，预计总奖金池超5000万卢布',
         '本土电竞赛事生态持续发展；Dota2/CS2内容营销机会增加',
         ''],
    ]
)

wb.save(OUTPUT_FILE)
print(f"✅ 2026年2月月报已生成：{OUTPUT_FILE}")
