...
top_events = [
    ...
    ["#2", "GTA6社区预热（官方营销未在3月分析周期内确认）", "Grand Theft Auto VI", "全球", "Reddit·YouTube·Instagram·Times Square",
     "（已核实并删除：Times Square广告牌为2025年5月事件，非March 2026分析周期；已从报告中删除）",
     "悬念营销·社区预热",
     "十年等待情绪释放，全球狂欢式预期",
     "发售日一再拖延，部分玩家出现疲劳与质疑"],
...
cn_mobile = [
    ...
    ['畅销#3', '原神', '开放世界ARPG', '米哈游', 'iOS/安卓（官网/TapTap）', '5.4版本「梦间见月明」于2026年2月12日上线，持续至3月26日；5.5版本「众火溯还之日」于2026年3月26日正式上线，新5星角色伊安珊（雷元素辅助）上线，新区域「沃陆之邦·圣山」开放探索，版本活动「荣花竞捷之争」同步开启（来源：ys.mihoyo.com官方公告）', '5.5版本纳塔主线高潮剧情获高度期待；伊安珊辅助机制设计被认为对队伍有实际加成；圣山区域探索内容量丰富', '3月1日-3月26日为5.4版本末期，活跃度明显下滑；伊安珊强度在卡池开启前已有争议讨论'],
    ...
    ['下载#5', '蛋仔派对', '休闲竞技', '网易', 'iOS/安卓（官网/TapTap）', '华为鸿蒙生态首发资源倾斜', '', ''],
]
cn_mkt = [
    ["沙威玛传奇", "手游", "玩家生成内容（UGC）",
    ...
    ["沙威玛传奇", "手游", "玩家生成内容（UGC）",
     ...
     "内容创作门槛较低，持续性存疑"],
    ["影之刃零", "PC主机", "网红合作",
     "影之刃零（灵犀互娱）于3月试玩测试期间集中KOL投放（正式公测定于2026年9月，来源：灵犀互娱官方公告），在抖音通过KOL发布试玩评测内容，平台内容集中出现并形成热度趋势；具体播放量建议通过飞瓜数据/蝉妈妈补充",
     "抖音",
    ...
    ["崩坏：星穹铁道", "手游", "网红合作",
     ...
     "部分玩家对付费角色强度不满，负面声音在评论区被放大"],
        # 已删除：崩坏：星穹铁道×华为/OPPO/vivo渠道合作条目
    # 核实说明：米哈游旗下游戏（原神/崩铁等）均未在华为应用市场、OPPO游戏中心、vivo游戏中心等
    # 安卓厂商应用商店官方上架，用户须通过米哈游官网或TapTap等第三方渠道下载，
    # 因此不存在与上述商店的首页推荐位采买或渠道合作，原条目属未经核实信息，已删除。
    ["原神", "手游", "异业联动",
...
make_market_sheet("中国大陆", "CN", "中国大陆 — 游戏市场营销热点月报",
    ...
    notes="平台：抖音·B站·小红书·微博·TapTap | 数据截至2026年3月31日（注：米哈游旗下游戏不在华为/OPPO/vivo应用商店上架）",
    policy_rows=[
