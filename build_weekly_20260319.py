...
cn_mobile = [
    ...
    ['畅销#5 (iOS CN)', '原神', '开放世界ARPG', '米哈游', 'iOS/安卓（官网/TapTap）', '5.5版本「众火溯还之日」：2026年3月26日全球同步上线（本周第一天）；新5星角色伊安珊（雷元素辅助）卡池开启，新区域「沃陆之邦·圣山」开放，版本活动「荣花竞捷之争」启动（全球统一运营·各区版本内容一致·来源：ys.mihoyo.com官方公告）', '5.5版本纳塔主线剧情被玩家期待为系列高潮；伊安珊辅助机制受到关注；圣山区域探索量丰富', '5.4版本末期等待积累了玩家焦虑；伊安珊强度争议在卡池开启前已发酵'],
...
out = "全球游戏市场热点周报_20260319-20260325_v1.xlsx"
wb.save(out)
print("OK:" + out)
